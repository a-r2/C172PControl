...
class Scenario():
    def __init__(self, scenario_type):
        ...
        self.telem_ip_address      = TELEM_IP_ADDRESS
    ...
    def cruise(self):
        ...
        telem_tx_str              = "--generic=socket,in," + str(self.telem_tx_hz) + "," + self.telem_ip_address + "," + str(self.telem_tx_port) + ",tcp," + self.tx_protocol_filename
